...
impl<'se, WriteT> ser::Serializer for &'se mut CborSerializer<WriteT>
where
    WriteT: io::Write,
{
    type Ok = ();
    type Error = SerdeProblem;
    type SerializeSeq = CborSeqSerializer<'se, WriteT>;
    type SerializeTuple = CborTupleSerializer<'se, WriteT>;
    type SerializeTupleStruct = CborTupleStructSerializer<'se, WriteT>;
    type SerializeTupleVariant = CborTupleVariantSerializer<'se, WriteT>;
    type SerializeMap = CborMapSerializer<'se, WriteT>;
    type SerializeStruct = CborStructSerializer<'se, WriteT>;
    type SerializeStructVariant = CborStructVariantSerializer<'se, WriteT>;
...
pub struct CborSeqSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    serializer: &'se mut CborSerializer<WriteT>,
    known: bool,
}

impl<'se, WriteT> ser::SerializeSeq for CborSeqSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    type Ok = ();
...
pub struct CborTupleSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    serializer: &'se mut CborSerializer<WriteT>,
...
impl<'se, WriteT> ser::SerializeTuple for CborTupleSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    type Ok = ();
...
pub struct CborTupleStructSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    serializer: &'se mut CborSerializer<WriteT>,
...
impl<'se, WriteT> ser::SerializeTupleStruct for CborTupleStructSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    type Ok = ();
...
pub struct CborTupleVariantSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    serializer: &'se mut CborSerializer<WriteT>,
...
impl<'se, WriteT> ser::SerializeTupleVariant for CborTupleVariantSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    type Ok = ();
...
pub struct CborMapSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    serializer: &'se mut CborSerializer<WriteT>,
...
impl<'se, WriteT> ser::SerializeMap for CborMapSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    type Ok = ();
...
pub struct CborStructSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    serializer: &'se mut CborSerializer<WriteT>,
...
impl<'se, WriteT> ser::SerializeStruct for CborStructSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    type Ok = ();
...
pub struct CborStructVariantSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    serializer: &'se mut CborSerializer<WriteT>,
...
impl<'se, WriteT> ser::SerializeStructVariant for CborStructVariantSerializer<'se, WriteT>
where
    WriteT: io::Write,
{
    type Ok = ();
